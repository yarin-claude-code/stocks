...
| TanStack Router file-based | routeTree.gen.ts auto-generated by TanStackRouterVite plugin on build |
| /_authenticated layout | beforeLoad guard redirects to /login if no session |
